...
func TestValidateCIDR(t *testing.T) {
	tests := []struct {
		...
		{"173.245.48.0/20", false, true},
		{"1.1.1.1", false, true},
		{"173.245.48.0", false, true},
		{"2400:cb00::/32", true, true},
		{"2606:4700::/32", true, true},
		{"2001:4860:4860::8888", true, true},
		{"", false, false},
		{"999.1.1.1/24", false, false},
		{"1.2.3.4/33", false, false},
		{"not-an-ip", false, false},
		{"2606:4700::/999", true, false},
	}
...
func TestNormalizeCIDR(t *testing.T) {
	tests := []struct{ in, want string }{
		{"181.199.62.245", "181.199.62.245/32"},
