...
//go:embed pgsql-docker pgsql-cluster pgsql-bare df-dockerized libsql-dockerized nats-dockerized etcd yuga-docker yuga-bare yuga-cluster nats-cluster nats-bare df-bare etcd-bare
