#!/bin/sh
# df-bare gen-certs - generate TLS certificates for the HAProxy entrypoint
set -e

TLS_DIR="${TLS_DIR:-./ssl}"
mkdir -p "$TLS_DIR"

echo "=== df-bare gen-certs ==="
...
# Concatenate cert+key into the PEM HAProxy loads
